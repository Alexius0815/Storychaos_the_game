...
const CONTENT = {
  de: {
    ...
    categoryLabels: { alltag: "🏠 Alltag", essen: "🍕 Essen", natur: "🌲 Natur", tech: "🤖 Tech", orte: "🏛 Orte", gefuehle: "💫 Gefuehle", objekte: "🎩 Objekte", misc: "👤 Personen" },
    aiSystem: "Kreativer Geschichtenerzaehler auf Deutsch.",
    aiPrompt: (genre, words) => `Schreibe eine kurze witzige Geschichte auf Deutsch im Stil "${genre}". 8-12 Saetze. Diese Woerter ALLE einbauen: ${words.join(", ")}. Jedes dieser Woerter mit **Wort** markieren. NUR die Geschichte, kein Titel. Locker lustig zum Vorlesen.`,
  },
  en: {
    words: {
      ...
      gefuehle: ["Panic","Jealousy","Euphoria","Homesickness","Nightmare","Silence","Curiosity","Dizziness","Goosebumps","Boredom","Longing","Defiance","Shame","Pride","Awe"],
    ...
    categoryLabels: { alltag: "🏠 Everyday", essen: "🍕 Food", natur: "🌲 Nature", tech: "🤖 Tech", orte: "🏛 Places", gefuehle: "💫 Feelings", objekte: "🎩 Objects", misc: "👤 Characters" },
...
const UI = {
  de: {
    subtitle: "Das Partyspiel gegen den Erzaehler",
    ...
    home: {
      ...
      steps: [
        ...
        "Alle auf Ich bin bereit druecken",
        "Host liest KI-Geschichte vor",
        "Alle reagieren heimlich – Host raet wer was hatte",
      ],
    },
    join: {
    ...
    cards: {
      ...
      desc: 'Jeder bekommt ein geheimes Wort und eine Aktion direkt aufs Handy. Danach muss jeder auf "Ich bin bereit" druecken bevor du die Geschichte generieren kannst.',
      gameLanguage: "Spielsprache",
      difficulty: "Aktions-Schwierigkeit",
      categories: "Wort-Kategorien",
      minCategory: "Mindestens eine Kategorie auswaehlen!",
    ...
    storyGen: {
      title: "✨ KI-Geschichte",
      desc: "Waehle ein Thema. Die Geschichte enthaelt die Woerter aller Mitspieler. Du liest vor – beobachte die Reaktionen!",
      includedWords: "Einzubauende Woerter",
      theme: "Thema",
      ...
      regenerate: "Neu ↻",
      hiddenHint: "Woerter sind versteckt – beobachte wer wann reagiert!",
      revealTitle: "Aufloesen – erst nach dem Raten!",
      revealWords: "Woerter aufdecken",
    },
    resolution: {
      title: "🎭 Aufloesung",
    ...
    rounds: {
      title: "🔄 Runden-Uebersicht",
      round: "Runde",
      currentNarrator: "Aktueller Erzaehler",
      current: "dran",
      done: "war dran",
      waiting: "wartet",
      allNarrators: "🎉 Alle waren Erzaehler!",
      gameFinished: "Spiel beendet – Endstand im Punkte-Tab",
    },
    hostTabs: { lobby: "Lobby", cards: "Karten", ready: "Bereit", story: "Story", timer: "Timer", resolve: "Loesung", scores: "Punkte", rounds: "Runden" },
    player: {
      ...
      storyRunning: "Story laeuft!",
      reactHint: "Reagiere wenn dein Wort faellt. Bleib unauffaellig 😏",
      yourWord: "Dein Wort:",
    },
    debug: {
      title: "🛠 Debug Panel",
      ...
      rooms: (n) => `Raeume (${n})`,
      deleteOld: "Alte loeschen",
      noRooms: "Keine Raeume",
      logs: (n) => `Logs (${n})`,
      noLogs: "Keine Logs",
      ok: "OK",
      fail: "FEHLER",
      deletedRooms: "Alte Raeume geloescht",
      debugOpened: "Debug geoeffnet",
    },
  },
  en: {
...
function QRCode({ url, size = 180, C, lang }) {
  ...
  return (
    <img
      ...
      alt={lang === "de" ? `QR Code fuer ${url}` : `QR code for ${url}`}
      width={size}
      height={size}

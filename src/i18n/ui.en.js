export default {
    ...
    storyGen: {
      title: "✨ Read aloud",
      desc: "Freestyle is the fastest path: you get a mixed prompt pool and tell the story yourself. If you prefer a ready-made story, you can optionally choose a theme as well.",
      ...
      theme: "Theme",
      primaryMode: "Freestyle first",
      freestylePrimary: "Start freestyle",
      freestyleChip: "Freestyle • no theme",
      localThemeChip: (label) => `Local story • ${label}`,
      localOptionTitle: "Local story",
      localOptionDesc: "If you would rather read a ready-made story than freestyle, choose a theme here as an optional extra.",
